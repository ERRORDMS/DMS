...
var SliceTable = (function (_super) {
    ...
    function SliceTable(_dataItemProvider, modelJson, serializer) {
        ...
        _this.dimensions = analytics_utils_1.deserializeArray(modelJson.Dimensions, function (item) { return new data_item_1.DataItemLink(_dataItemProvider, item, serializer); });
        _this.measures = analytics_utils_1.deserializeArray(modelJson.Measures, function (item) { return new data_item_1.DataItemLink(_dataItemProvider, item, serializer); });
        return _this;
    }
