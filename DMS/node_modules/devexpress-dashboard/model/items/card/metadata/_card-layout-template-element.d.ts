...
export declare let сardRowDataElementTypeValuesMap: {
    [key in CardRowDataElementType]: DashboardLocalizationId;
};
export declare let сardFormatRuleLayoutElementValuesMap: {
    [key in CardFormatRuleLayoutElement]: DashboardLocalizationId;
};
export declare let сardRowDataElementTypeValuesMapEx: {
