...
var GaugeItem = (function (_super) {
    ...
    function GaugeItem(modelJson, serializer) {
        ...
        _this.gauges = analytics_utils_1.deserializeArray(modelJson.Gauges, function (item) { return new gauge_1.Gauge(_this, item, serializer); });
        return _this;
    }
    ...
    GaugeItem.prototype._itemInteractivityByColumnAxis = function () {
        return false;
    };
    GaugeItem.prototype._getInteractivityAxisDimensionCount = function () {
