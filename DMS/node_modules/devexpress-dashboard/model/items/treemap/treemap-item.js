...
var TreemapItem = (function (_super) {
    ...
    function TreemapItem(modelJson, serializer) {
        ...
        _this.__arguments(analytics_utils_1.deserializeArray(modelJson.Arguments, function (item) { return new data_item_1.DataItemLink(_this, item, serializer); })());
        _this._subscribeDataItemLinkArrays(_treemap_item_1.treeMapArgumentsMeta);
        _this.__values = analytics_utils_1.deserializeArray(modelJson.Values, function (item) { return new data_item_1.DataItemLink(_this, item, serializer); });
