...
var GridColumn = (function (_super) {
    ...
    function GridColumn(dataItemProvider, dashboardItemJSON, serializer) {
        ...
        _this.totals = analytics_utils_1.deserializeArray(dashboardItemJSON.Totals, function (item) { return new grid_column_total_1.GridColumnTotal(item, serializer); });
        return _this;
    }
...
var GridHyperlinkColumn = (function (_super) {
    ...
    GridHyperlinkColumn.prototype._getAvailableTotalTypes = function (dataItemProvider) {
