...
var _grid_column_filter_options_1 = require("./metadata/_grid-column-filter-options");
var GridColumnFilterOptions = (function (_super) {
    __extends(GridColumnFilterOptions, _super);
    function GridColumnFilterOptions(JSON, serializer) {
        if (JSON === void 0) { JSON = {}; }
        if (serializer === void 0) { serializer = new analytics_utils_1.ModelSerializer(); }
        return _super.call(this, JSON, serializer) || this;
    }
    GridColumnFilterOptions.prototype.getInfo = function () {
        return _grid_column_filter_options_1.gridColumnFilterOptionsSerializationsInfo;
    };
    GridColumnFilterOptions.prototype._getViewModel = function () {
        return {
