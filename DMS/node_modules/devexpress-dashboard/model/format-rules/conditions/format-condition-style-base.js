...
var currentStyleSettingsInfo = function (styleSettingsType) {
    return !styleSettingsType ? undefined : __assign(__assign({}, _format_rules_common_1.styleSettings), { modelName: styleSettingsType(), type: _style_settings_utils_1.styleSettingsTypesMap[styleSettingsType()] });
};
