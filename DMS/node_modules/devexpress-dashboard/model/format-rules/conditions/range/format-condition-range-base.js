...
var FormatConditionRangeBase = (function (_super) {
    ...
    FormatConditionRangeBase.prototype.setValues = function (values) {
        ...
        var index = 0;
        var valueType = this.valueType() === 'Percent' ? 'System.Double' : _format_rules_common_1.fieldTypes[this.dataType()];
        values.forEach(function (value) { return _this.rangeSet.ranges()[index++].value.setValue(value, valueType); });
    };
