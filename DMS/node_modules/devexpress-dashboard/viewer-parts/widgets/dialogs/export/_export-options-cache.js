...
var exportOptionsCache = (function () {
    ...
    exportOptionsCache.prototype.add = function (dashboardItemName, defaultDocumentInfo, actualDocumentInfo) {
        var that = this;
    ...
    exportOptionsCache.prototype.getActualDocumentInfo = function (dashboardItemName, defaultDocumentInfo) {
        var that = this;
