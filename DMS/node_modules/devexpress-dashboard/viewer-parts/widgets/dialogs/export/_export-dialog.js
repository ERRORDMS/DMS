...
var exportDialog = (function () {
    ...
    exportDialog.prototype._initialize = function () {
        ...
        that.dialogForm = new _dialog_form_1.dialogForm({
            ...
            buttons: [{
                    ...
                    hide: true,
                    func: function () {
                        var defaultDocumentInfo = options.defaultDocumentInfo;
    ...
    exportDialog.prototype.showDialog = function (dashboardItemName, dashboardItemType, format, options) {
    ...
    exportDialog.prototype._createImageGroup = function (dashboardItemType, documentInfo) {
    ...
    exportDialog.prototype._createExcelGroup = function (dashboardItemType, documentInfo) {
        switch (dashboardItemType) {
            case null:
    ...
    exportDialog.prototype._createPdfGroup = function (dashboardItemType, documentInfo) {
        switch (dashboardItemType) {
            case null:
