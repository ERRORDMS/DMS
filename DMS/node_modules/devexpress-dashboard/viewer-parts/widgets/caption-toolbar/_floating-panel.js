...
var FloatingPanel = (function () {
    function FloatingPanel(options) {
        ...
        overlayOptions = __assign(__assign({}, overlayOptions), { target: options.container, container: options.container, closeOnSwipe: false, propagateOutsideClick: true });
    ...
    FloatingPanel.prototype._calculateToolbarWidth = function () {
        if (!this._maxWidth) {
            var toolbarItemGroupsContainer = this._container.querySelector("." + _caption_toolbar_css_classes_1.cssClasses.floatingContainer + " .dx-toolbar-items-container");
