...
import { СhartItemStyleSettingsProvider } from '../conditional-formatting/_chart-item-style-settings-provider';
...
export declare class chartItem extends baseItem {
    ...
    _styleSettingsProvider: СhartItemStyleSettingsProvider;
