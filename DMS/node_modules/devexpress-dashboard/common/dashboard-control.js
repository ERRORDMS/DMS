...
var DashboardControl = (function () {
    ...
    DashboardControl.prototype._loadDashboardCore = function (dashboardId) {
        var _this = this;
        var isValidRequest = _helpers_1.requestParamsValidator.isValid({ dashboardId: dashboardId });
    ...
    DashboardControl.prototype._registerExtensionCore = function (extension) {
        var camelCaseExtensionName = this._getCamelCaseExtensionName(extension.name);
