        ...
        tab.tabModel(new _object_properties_wrapper_1.ObjectPropertiesWrapper({
            ...
            properties: [
                ...
                _custom_shape_file_1.customShapefileUrl,
                {
                    ...
                    properties: [__assign(__assign({}, _custom_shape_file_data_1.shapeData), { formAdapterItem: _form_adapter_editors_1.filePickerEditor({
                                type: 'file',
                                accept: '.shp',
                                placeholderId: 'DashboardWebStringId.Map.ShapeFileLoaded',
                                showClearButton: true,
                                readMode: undefined
                            }) }), __assign(__assign({}, _custom_shape_file_data_1.attributeData), { formAdapterItem: _form_adapter_editors_1.filePickerEditor({
                                type: 'file',
                                accept: '.dbf',
