...
function _registerFederatedQueryConfigurePage(factory, wizardOptions) {
    var analyticsMeta = factory.getMetadata(analytics_wizard_1.FederationDataSourceWizardPageId.FederatedQueryConfigurePage);
    if (!analyticsMeta) {
    ...
    var dashboardMeta = __assign({}, analyticsMeta);
    var analyticsMetaCreate = analyticsMeta.create;
    dashboardMeta.create = function () {
        var page = analyticsMetaCreate();
        page.canNext = function () { return false; };
        return page;
    };
