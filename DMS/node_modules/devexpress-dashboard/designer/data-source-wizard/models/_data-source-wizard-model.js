...
}(queryBuilder_utils_1.RequestWrapper));
...
var DashboardDataSourceWizardOptions = (function (_super) {
    ...
    function DashboardDataSourceWizardOptions() {
        var _this = _super.call(this) || this;
        _this.connectionStrings = __assign(__assign({}, _this.connectionStrings), { olap: [] });
        _this.wizardSettings = __assign(__assign({}, _this.wizardSettings), { enableOlapDataSource: false });
        return _this;
    }
    return DashboardDataSourceWizardOptions;
}(analytics_wizard_1._DataSourceWizardOptions));
...
}(analytics_wizard_1._MultiQueryDataSourceWizardOptions));
