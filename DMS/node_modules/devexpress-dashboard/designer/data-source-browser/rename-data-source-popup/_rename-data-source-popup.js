...
var _rename_data_source_viewmodel_1 = require("./_rename-data-source-viewmodel");
var RenameDataSourcePopup = (function () {
    function RenameDataSourcePopup(dataSourceBrowser) {
    ...
    RenameDataSourcePopup.prototype.show = function (dataSource) {
        this._viewModel.show(dataSource);
    };
    return RenameDataSourcePopup;
}());
