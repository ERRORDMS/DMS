...
var _layout_item_1 = require("../../common/docking-layout/core/_layout-item");
...
var TextBoxItemEditorExtension = (function (_super) {
    ...
    TextBoxItemEditorExtension.prototype.start = function () {
        ...
        if (contextMenuExtension && propertiesPanelExtension) {
            this.toDispose(_knockout_utils_1.subscribeAndPerform(contextMenuExtension._itemContextMenu, function (menu) {
                if (menu) {
