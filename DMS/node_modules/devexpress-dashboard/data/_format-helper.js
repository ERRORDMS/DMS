...
format_helper_1.default.inject({
    ...
    _normalizeFormatConfig: function (format, precision, value) {
        var config = number_1.default._normalizeFormatConfig(format, {
            precision: precision,
            useCurrencyAccountingStyle: this._accountingStyle !== undefined ? this._accountingStyle : legacy_settings_1.DashboardPrivateSettings.useCurrencyAccountingStyle
        }, value);
        if (format === 'decimal') {
